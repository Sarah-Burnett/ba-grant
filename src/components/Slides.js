...
const Slides = ({url, redirectMsg='Back to Home', redirectUrl='/', progress}) => {
    ...
    return (
        <React.Fragment>
            <CSSTransition in={!loading && viewAsSlideshow} timeout={1000} classNames="fade" mountOnEnter unmountOnExit>
