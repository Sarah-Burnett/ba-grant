import { TutorialLink } from '../components/links/TutorialLink';
...
export const qualtrics = [
    ...
    {
        name: "Support pages",
        url:  "https://www.qualtrics.com/support/survey-platform/my-projects/my-projects-overview/",
        Component: ExternalLink,
...
export const eprime = [
    ...
    {
        name: "Eprime guide",
        url:  "https://universityofexeteruk.sharepoint.com/sites/BA_Regulatory_Focus_and_Rumination/Shared%20Documents/Forms/AllItems.aspx?id=%2Fsites%2FBA%5FRegulatory%5FFocus%5Fand%5FRumination%2FShared%20Documents%2F2020%20documents%20and%20protocol%2FE%2DPrime%20scripts%2FEPrime2%2E0GettingStartedGuide%2Epdf&parent=%2Fsites%2FBA%5FRegulatory%5FFocus%5Fand%5FRumination%2FShared%20Documents%2F2020%20documents%20and%20protocol%2FE%2DPrime%20scripts",
        Component: ExternalLink,
        state: "eprimeGuide",
    },
    {
...
export const psychophys = [
    ...
    },
    {
        ...
        url:  "https://www.biopac.com/wp-content/uploads/acqknowledge-4-software-guide.pdf",
        Component: ExternalLink,
